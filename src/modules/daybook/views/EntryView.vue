<template>
  ...
  <Fab icon="fa-save"/>
  <img src="https://www.fayerwayer.com/resizer/vkyu1e90hn_uQQwm0UuF8wKta3s=/1440x810/filters:format(jpg):quality(70)/cloudfront-us-east-1.images.arcpublishing.com/metroworldnews/QDCCY6ERFZDQLLIFU2UNH7NNF4.jpg" 
  alt="entry-picture"
  class="img-thumbnail">
</template>
